...
#import "AppotaPopoverViewCompatibility.h"
...
@class AppotaPopoverView;

@protocol AppotaPopoverViewDelegate <NSObject>

@optional

//Delegate receives this call as soon as the item has been selected
- (void)popoverView:(AppotaPopoverView *)popoverView didSelectItemAtIndex:(NSInteger)index;

//Delegate receives this call once the popover has begun the dismissal animation
- (void)popoverViewDidDismiss:(AppotaPopoverView *)popoverView;

@end

@interface AppotaPopoverView : UIView {
    CGRect boxFrame;
    CGSize contentSize;
    CGPoint arrowPoint;
    ...
    __WEAK id<AppotaPopoverViewDelegate> delegate;
...
@property (nonatomic, WEAK) id<AppotaPopoverViewDelegate> delegate;
...
+ (AppotaPopoverView *)showPopoverAtPoint:(CGPoint)point inView:(UIView *)view withText:(NSString *)text delegate:(id<AppotaPopoverViewDelegate>)delegate;

+ (AppotaPopoverView *)showPopoverAtPoint:(CGPoint)point inView:(UIView *)view withTitle:(NSString *)title withText:(NSString *)text delegate:(id<AppotaPopoverViewDelegate>)delegate;

+ (AppotaPopoverView *)showPopoverAtPoint:(CGPoint)point inView:(UIView *)view withViewArray:(NSArray *)viewArray delegate:(id<AppotaPopoverViewDelegate>)delegate;

+ (AppotaPopoverView *)showPopoverAtPoint:(CGPoint)point inView:(UIView *)view withTitle:(NSString *)title withViewArray:(NSArray *)viewArray delegate:(id<AppotaPopoverViewDelegate>)delegate;

+ (AppotaPopoverView *)showPopoverAtPoint:(CGPoint)point inView:(UIView *)view withStringArray:(NSArray *)stringArray delegate:(id<AppotaPopoverViewDelegate>)delegate;

+ (AppotaPopoverView *)showPopoverAtPoint:(CGPoint)point inView:(UIView *)view withTitle:(NSString *)title withStringArray:(NSArray *)stringArray delegate:(id<AppotaPopoverViewDelegate>)delegate;

+ (AppotaPopoverView *)showPopoverAtPoint:(CGPoint)point inView:(UIView *)view withTitle:(NSString *)title withStringArray:(NSArray *)stringArray withImageButtonNameArray:(NSArray*) buttonImageNameArray delegate:(id<AppotaPopoverViewDelegate>)delegate;

+ (AppotaPopoverView *)showPopoverAtPoint:(CGPoint)point inView:(UIView *)view withStringArray:(NSArray *)stringArray withImageArray:(NSArray *)imageArray delegate:(id<AppotaPopoverViewDelegate>)delegate;

+ (AppotaPopoverView *)showPopoverAtPoint:(CGPoint)point inView:(UIView *)view withTitle:(NSString *)title withStringArray:(NSArray *)stringArray withImageArray:(NSArray *)imageArray delegate:(id<AppotaPopoverViewDelegate>)delegate;

+ (AppotaPopoverView *)showPopoverAtPoint:(CGPoint)point inView:(UIView *)view withTitle:(NSString *)title withContentView:(UIView *)cView delegate:(id<AppotaPopoverViewDelegate>)delegate;

+ (AppotaPopoverView *)showPopoverAtPoint:(CGPoint)point inView:(UIView *)view withContentView:(UIView *)cView delegate:(id<AppotaPopoverViewDelegate>)delegate;
